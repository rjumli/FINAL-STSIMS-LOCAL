...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchAddress: function fetchAddress() {
      var _this = this;
      this.isLoading = true;
      axios.get(this.currentUrl + '/sync/locations/check/all').then(function (response) {
