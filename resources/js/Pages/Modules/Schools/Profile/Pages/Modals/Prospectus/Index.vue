<template>
            ...
            <div class="col-md-3">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <div class="flex-shrink-0">
                        <button @click="openCreate(course)" class="btn btn-soft-primary btn-sm text-nowrap flex-shrink-0" type="button">
                            <div class="btn-content"><i class="ri-add-line align-bottom me-1"></i> New Prospectus</div>
                        </button>
                    </div>
                </div>
                <hr />
                <div id="external-events" v-if="course.prospectuses.length > 0">
                    <div @click="showProspectus(list,index)" style="cursor: pointer;" v-for="(list, index) of course.prospectuses" :key="index" class="external-event fc-event" :class="(list.is_active) ? 'bg-success-subtle text-success' : 'bg-primary-subtle text-primary'">
                                ...
                                <b-row class="mt-n4 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="hstack float-end gap-2 mt-4 mt-sm-0">
                                             <button @click="openStatus(prospectus,'lock')" v-b-tooltip.hover :title="(prospectus.is_locked) ? 'Unlock' : 'Lock'" class="btn btn-sm btn-light float-end mt-1 me-0" type="button">
                                            ...
                                            <button @click="openStatus(prospectus,'status')" class="btn btn-sm btn-label mt-1" :class="(prospectus.is_active) ? 'btn-danger' : 'btn-success'" type="button">
                                            ...
                                            <button v-if="!prospectus.is_locked" @click="openSave(prospectus,'update')" class="btn btn-primary btn-sm btn-label mt-1" type="button">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <b-tabs v-model="tabIndex2">
                                        <b-tab v-for="(s,index2) in semester.semesters" v-bind:key="index2">
                                            <table class="table table-bordered mb-0"> 
                                                <thead>
                                                    <tr class="text-center text-danger fw-bold font-size-12">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="(course, index3) in s.courses" v-bind:key="'a-'+index3" class="mb-n4" style="display: block;">
                                                            ...
                                                            <td class="text-end" width="2%">
                                                                <b-button @click="removeButton(index,index2,index3)" variant="soft-danger" v-b-tooltip.hover title="Remove" class="edit-list"><i class="ri-delete-bin-5-line align-bottom"></i> </b-button>
                                                            </td>
                                                        </tr>
                                            ...
                                            <table class="table table-bordered mb-0">
                                                <tbody>
                                                    <tr class="bg-opacity-10">
                                                        <td>
                                                            <button @click="addButton(index,index2)" class="btn btn-secondary btn-md btn-label me-1" type="button">
    ...
    <Create :term="term" @status="update" ref="create"/>
    <Status ref="status"/>
    <Save ref="save"/>
    <!-- <Lock ref="lock"/> -->
</template>
