<template>
    <b-col lg>
        <div class="input-group mb-3 mt-n1">
            ...
            <span @click="openCreateList()" class="input-group-text" v-b-tooltip.hover title="Group Semester" style="cursor: pointer;"> 
    ...
    <Create :semesters="semesters" @status="message" ref="create"/>
    <CreateList :semesters="semesters" ref="createlist"/>
</template>

<script>
import Create from './Modals/Semester/Create.vue';
import CreateList from './Modals/Semester/CreateList.vue'
import Pagination from "@/Shared/Components/Pagination.vue";
export default {
    components : { Pagination, Create, CreateList },
